package net.mcreator.muchofbiomes.world.features.treedecorators;
...
@EventBusSubscriber
public class ParrotJungleLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<ParrotJungleLeaveDecorator> CODEC = MapCodec.unit(ParrotJungleLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("muchof_biomes:parrot_jungle_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public ParrotJungleLeaveDecorator() {
		super(0.25f);
	}
