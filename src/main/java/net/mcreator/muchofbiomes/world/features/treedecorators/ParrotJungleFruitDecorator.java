...
@EventBusSubscriber
public class ParrotJungleFruitDecorator extends CocoaDecorator {
	public static MapCodec<ParrotJungleFruitDecorator> CODEC = MapCodec.unit(ParrotJungleFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("muchof_biomes:parrot_jungle_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}

	public ParrotJungleFruitDecorator() {
		super(0.2f);
	}
