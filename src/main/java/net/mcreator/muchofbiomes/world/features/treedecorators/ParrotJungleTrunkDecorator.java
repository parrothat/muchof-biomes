...
@EventBusSubscriber
public class ParrotJungleTrunkDecorator extends TrunkVineDecorator {
	public static MapCodec<ParrotJungleTrunkDecorator> CODEC = MapCodec.unit(ParrotJungleTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("muchof_biomes:parrot_jungle_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
